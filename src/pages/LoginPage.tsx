...
function LoginPage() {
  return (
    <div className="bg-neutral-50 h-full w-full flex items-center justify-center">
      <div className="bg-neutral-300 rounded-lg flex flex-col items-center p-12 px-36 py-16">
        ...
        />
        <InputField labelTop={true} label="Username" type="text" />
        <InputField labelTop={true} label="Password" type="password" />
